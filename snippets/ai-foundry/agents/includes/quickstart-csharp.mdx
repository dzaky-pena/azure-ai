...
import UniversalPrerequisites from '/snippets/ai-foundry/agents/includes/universal-prerequisites.mdx'

<UniversalPrerequisites />
...
import ModelNamePortal from '/snippets/ai-foundry/agents/includes/model-name-portal.mdx'
