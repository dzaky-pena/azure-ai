<Tip>
The rest of this article shows how to create a **[!INCLUDE [fdp](../includes/fdp-project-name)]**.  Select **[!INCLUDE [hub](../includes/hub-project-name)]** at the top of this article if you want to create a [!INCLUDE [hub](../includes/hub-project-name)] instead.
</Tip>
...
Use the following tabs to select the method you plan to use to create a [!INCLUDE [fdp](../includes/fdp-project-name)]:
...
## Create a [!INCLUDE [fdp-project-name](fdp-project-name)]
...
To create a [!INCLUDE [fdp-project-name](fdp-project-name)] in [Azure AI Foundry](https://ai.azure.com/?cid=learnDocs), follow these steps:
...
A [!INCLUDE [fdp-project-name](fdp-project-name)] is created on an `AI Foundry` resource. This resource is created for you automatically when you create the project. 
...
To create a [!INCLUDE [fdp](../includes/fdp-project-name)]:


1. Add this code to create a [!INCLUDE [fdp-project-name](../includes/fdp-project-name)], using the variables and `client` connection from the [Prerequisites](#prerequisites).
...
[!INCLUDE [create-second-fdp-project](create-second-fdp-project)]
