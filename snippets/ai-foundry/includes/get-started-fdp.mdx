...
<Tip>
    The rest of this article shows how to use a **<Fdp />**. Select **<Hub />** at the top of this article if you want to use a <Hub /> instead. [Which type of project do I need?](../what-is-azure-ai-foundry.md#which-type-of-project-do-i-need)
</Tip>
...
1. On the home page, search and then select the **gpt-4o** model. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/quickstarts/start-building.png)
    </Frame>
...
1. [Install Python and Azure CLI](../how-to/develop/install-cli-sdk)
...
1. [Install Java and Azure CLI](../how-to/develop/install-cli-sdk).
...
1. [Install Node.js and Azure CLI](../how-to/develop/install-cli-sdk)
...
1. [Install C# and Azure CLI](../how-to/develop/install-cli-sdk)
1. Install packages:

import InstallCsharpPackages from '/snippets/ai-foundry/includes/install-csharp-packages.mdx'

    <InstallCsharpPackages />
...
* Download [product_info_1.md](https://github.com/azure-ai-foundry/foundry-samples/blob/main/samples/microsoft/data/product_info_1) to give to your agent.
...
> [Azure AI Foundry client library overview](../how-to/develop/sdk-overview)
