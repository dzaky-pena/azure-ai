...
<Tip>
The rest of this article shows how to use a **[!INCLUDE [fdp](../includes/fdp-project-name)]**. Select **[!INCLUDE [hub](../includes/hub-project-name)]** at the top of this article if you want to use a [!INCLUDE [hub](../includes/hub-project-name)] instead. [Which type of project do I need?](../what-is-azure-ai-foundry.md#which-type-of-project-do-i-need)
</Tip>
...
[!INCLUDE [feature-preview](feature-preview)]
...
1. [!INCLUDE [find-endpoint](find-endpoint)]
...
1. Install packages:
    ...
    [!INCLUDE [install-csharp-packages](install-csharp-packages)]
...
[!INCLUDE [clean-up-resources](clean-up-resources)]
