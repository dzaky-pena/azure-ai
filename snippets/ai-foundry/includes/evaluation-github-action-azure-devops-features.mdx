...
- **Built-in Evaluators**: Leverage existing evaluators provided by the [Azure AI Evaluation SDK](../how-to/develop/evaluate-sdk).
    ...
    | [Custom evaluators](../concepts/evaluation-evaluators/custom-evaluators) |  | Not Supported | Not Supported |
