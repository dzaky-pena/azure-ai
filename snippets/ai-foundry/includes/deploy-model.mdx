...
1. Studio remembers where you were last, so what you do next depends on where you are:
    ...
    * If you see a list of projects, select the one you want to use.  You can use either a [!INCLUDE [hub-project-name](hub-project-name)] or a [!INCLUDE [fdp-project-name](fdp-project-name)].
