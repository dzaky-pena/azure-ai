---
title: "Azure OpenAI Python support in Azure AI Foundry Models"
description: Azure OpenAI Python support
---

[Library source code](https://github.com/openai/openai-python?azure-portal=true) | [Package (PyPi)](https://pypi.org/project/openai?azure-portal=true) | [Reference](../../reference) |
...
import AzureKeyVault from '/snippets/ai-foundry/openai/includes/language-overview/~/reusable-content/ce-skilling/azure/includes/ai-services/security/azure-key-vault.mdx'
...
[Fine-tuning with Python how-to article](../../how-to/fine-tuning)

## Batch

[Batch with Python how-to article](../../how-to/batch)
...
See the [Responses API](../../how-to/responses) documentation.
