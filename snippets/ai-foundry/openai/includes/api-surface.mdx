---
title: "Azure OpenAI API surfaces in Azure AI Foundry Models"
...
- **API Key authentication**: For this type of authentication, all API requests must include the API Key in the ```api-key``` HTTP header. The [Quickstart](../chatgpt-quickstart) provides guidance for how to make calls with this type of authentication.
