...
- Access permissions to [create Azure OpenAI resources and to deploy models](../how-to/role-based-access-control).
...
1. Select **Create a resource** and search for the **Azure OpenAI**. When you locate the service, select **Create**.
   ...
   <Frame>
      ![](/images/ai-foundry/openai/media/create-resource/create-azure-openai-resource-portal.png)
   </Frame>
1. On the **Create Azure OpenAI** page, provide the following information for the fields on the **Basics** tab:
   ...
   <Frame>
      ![](/images/ai-foundry/openai/media/create-resource/create-resource-basic-settings.png)
   </Frame>
1. Select **Next**.
...
<Frame>
   ![](/images/ai-foundry/openai/media/create-resource/create-resource-network-settings.png)
</Frame>
...
<Frame>
   ![](/images/ai-foundry/openai/media/create-resource/create-resource-network-settings-specific.png)
</Frame>
...
<Frame>
   ![](/images/ai-foundry/openai/media/create-resource/create-resource-network-settings-disable.png)
</Frame>
...
1. The Azure portal displays a notification when the new resource is available. Select **Go to resource**.
   ...
   <Frame>
      ![](/images/ai-foundry/openai/media/create-resource/create-resource-go-to-resource.png)
   </Frame>
...
4. Select **Create new deployment** and configure the following fields:
   ...
   |**Deployment type** | **Standard**, **Global-Batch**, **Global-Standard**, **Provisioned-Managed**. Learn more about [deployment type options](../how-to/deployment-types). |  
   | **Advanced options** (Optional) | You can set optional advanced settings, as needed for your resource. <br/> - For the **Content Filter**, assign a content filter to your deployment.<br/> - For the **Tokens per Minute Rate Limit**, adjust the Tokens per Minute (TPM) to set the effective rate limit for your deployment. You can modify this value at any time by using the [**Quotas**](../how-to/quota) menu. [**Dynamic Quota**](../how-to/dynamic-quota) allows you to take advantage of more quota when extra capacity is available. |
