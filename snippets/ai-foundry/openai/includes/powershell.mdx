---
title: ""Quickstart: Use the OpenAI Service via PowerShell" in Azure AI Foundry Models"
...
- An Azure OpenAI in Azure AI Foundry Models resource with a model deployed. For more information about model deployment, see the [resource deployment guide](../how-to/create-resource).
