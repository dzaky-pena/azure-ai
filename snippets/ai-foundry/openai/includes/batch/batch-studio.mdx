---
title: "Azure OpenAI Global Batch Studio in Azure AI Foundry Models"
...
* An Azure OpenAI resource with a model of the deployment type `Global-Batch` deployed. You can refer to the [resource creation and model deployment guide](../../how-to/create-resource) for help with this process.

## Preparing your batch file

Like [fine-tuning](../../how-to/fine-tuning), global batch uses files in JSON lines (`.jsonl`) format. Below are some example files with different types of supported content:
...
Once your input file is prepared, you first need to upload the file to then be able to initiate a batch job. File upload can be done both programmatically or via the Azure AI Foundry portal. This example demonstrates uploading a file directly to your Azure OpenAI resource. Alternatively, you can [configure Azure Blob Storage for Azure OpenAI Batch](../../how-to/batch-blob-storage). 
...
3. Select **Batch jobs** > **+Create batch jobs**.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/how-to/global-batch/create-batch-job-empty.png)
    </Frame>
...
4. From the dropdown under **Batch data** > **Upload files** > select **Upload file** and provide the path for the `test.jsonl` file created in the previous step > **Next**.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/how-to/global-batch/upload-file.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/global-batch/deployment.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/global-batch/job-id.png)
</Frame>

You can track job status for your job in the right-hand pane:

<Frame>
    ![](/images/ai-foundry/openai/media/how-to/global-batch/status.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/global-batch/output.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/global-batch/cancel.png)
</Frame>