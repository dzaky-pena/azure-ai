---
title: "Azure OpenAI Global Batch Python in Azure AI Foundry Models"
...
import AzureKeyVault from '/snippets/ai-foundry/openai/includes/batch/~/reusable-content/ce-skilling/azure/includes/ai-services/security/azure-key-vault.mdx'
