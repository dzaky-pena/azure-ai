---
title: "'Quickstart: Use GPT-4o and GPT-4o mini via Azure AI Foundry' in Azure AI Foundry Models"
...
- An Azure OpenAI in Azure AI Foundry Models resource with either `gpt-4o` or the `gpt-4o-mini` models deployed. We recommend using standard or global standard model [deployment types](../how-to/deployment-types) for initial exploration. For more information about model deployment, see the [resource deployment guide](../how-to/create-resource).
...
<Frame>
    ![](/images/ai-foundry/openai/media/quickstarts/chatgpt-playground-load-new.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/quickstarts/chat-view-code.png)
</Frame>
...
The [Chat completions how-to guide](../how-to/chatgpt) provides an in-depth introduction into the new prompt structure and how to use chat completions models effectively.

import DeployWebApp from '/snippets/ai-foundry/openai/includes/deploy-web-app.mdx'
...
* Learn more about how to work with the new `gpt-35-turbo` model with the [GPT-35-Turbo & GPT-4 how-to guide](../how-to/chatgpt).
