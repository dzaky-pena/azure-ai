...
<Tip>
You can [use the Azure Developer CLI](../how-to/azure-developer-cli) to programmatically create the resources needed for Azure OpenAI On Your Data 
</Tip>
...
1. You can either [create an Azure AI Foundry project](../../../ai-foundry/how-to/create-projects) by clicking **Create project**, or continue directly by clicking the button on the **Focused on Azure OpenAI in Azure AI Foundry Models** tile.  

    <Frame>
        ![](/images/ai-foundry/openai/media/use-your-data/ai-foundry-homepage.png)
    </Frame>
...
1. In the **Chat playground**, Select **Add your data** and then **Add a data source**
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/use-your-data/chat-playground.png)
    </Frame>
