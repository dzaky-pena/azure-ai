---
title: "'Quickstart: Use the OpenAI Service to make your first completions call with the REST API' in Azure AI Foundry Models"
...
The Azure OpenAI in Azure AI Foundry Models also performs content moderation on the prompt inputs and generated outputs. The prompts or responses may be filtered if harmful content is detected. For more information, see the [content filter](../concepts/content-filter) article.
