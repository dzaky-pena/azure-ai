...
- If you don't already have access to view quota and deploy models in Azure AI Foundry portal you need [more permissions](../how-to/role-based-access-control).
...
1. Sign in to [Azure AI Foundry](https://ai.azure.com/?cid=learnDocs) and select your project. If you don't have a project already, first [create a project](../../../ai-foundry/how-to/create-projects).

1. From the collapsible left menu, select **Fine-tuning** > **+ Fine-tune model**.

    <Frame>
        ![](/images/ai-foundry/openai/media/fine-tuning/ai-foundry/fine-tune-new.png)
    </Frame>
...
1. Then select **Next**.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/fine-tuning/ai-foundry/fine-tune-basic-settings.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/ai-foundry/fine-tune-training-data-local.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/ai-foundry/fine-tune-training-data-preview.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/checkpoints.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/metrics.png)
</Frame>
