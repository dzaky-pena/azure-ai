...
* An AI project connected to your Azure AI Services resource. You call follow the steps at [Configure Azure AI Foundry Models service in my project](../../how-to/configure-project-connection) in Azure AI Foundry.
