...
import Intro from '/snippets/ai-foundry/foundry-models/includes/use-structured-outputs/intro.mdx'
...
<Frame>
    ![](/images/ai-foundry/foundry-models/media/use-structured-outputs/example-graph-treecover.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/foundry-models/media/use-structured-outputs/graph-treecover-plot.png)
</Frame>
