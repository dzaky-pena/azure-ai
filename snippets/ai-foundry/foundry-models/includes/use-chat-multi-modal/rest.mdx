...
import FeaturePreview from '/snippets/ai-foundry/foundry-models/includes/use-chat-multi-modal/~/reusable-content/ce-skilling/azure/includes/ai-studio/includes/feature-preview.mdx'
...
* A chat completions model deployment. If you don't have one, see [Add and configure Foundry Models](../../how-to/create-model-deployments) to add a chat completions model to your resource.
...
<Frame>
    ![](/images/ai-foundry/media/how-to/sdks/small-language-models-chart-example.jpg)
</Frame>
