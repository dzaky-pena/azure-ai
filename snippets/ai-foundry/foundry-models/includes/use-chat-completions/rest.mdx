...
import FeaturePreview from '/snippets/ai-foundry/foundry-models/includes/use-chat-completions/~/reusable-content/ce-skilling/azure/includes/ai-studio/includes/feature-preview.mdx'
...
* A chat completions model deployment. If you don't have one, read [Add and configure Foundry Models](../../how-to/create-model-deployments) to add a chat completions model to your resource.
...
Using Microsoft Entra ID might require extra configuration in your resource to grant access. Learn how to [configure key-less authentication with Microsoft Entra ID](../../how-to/configure-entra-id).
...
The Foundry Models Inference API allows you to pass extra parameters to the model. The following code example shows how to pass the extra parameter `logprobs` to the model. 
