...
import FeaturePreview from '/snippets/ai-foundry/foundry-models/includes/use-chat-reasoning/~/reusable-content/ce-skilling/azure/includes/ai-studio/includes/feature-preview.mdx'
...
import HowToPrerequisitesOpenaiPython from '/snippets/ai-foundry/foundry-models/includes/how-to-prerequisites-openai-python.mdx'

<HowToPrerequisitesOpenaiPython />
...
Some models support the use of tools or structured outputs (including JSON-schemas). Read the [Models](../../concepts/models) details page to understand each model's support.
