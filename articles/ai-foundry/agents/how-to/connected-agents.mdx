...
* Connected agents cannot call local functions using the function calling tool. We recommend using the [OpenAPI tool](tools\openapi-spec) or [Azure Functions](tools\azure-functions) instead.
...
<Frame>
    ![](/images/ai-foundry/agents/media/connected-agents/connected-agents-foundry.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/agents/media/connected-agents/connected-agents-foundry-2.png)
</Frame>
</Tab>
...
<Note>
This shows a synchronous usage. You can find an asynchronous example on [GitHub](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/ai/Azure.AI.Projects/samples/Sample24_Agent_Connected_Agent) 
</Note>
