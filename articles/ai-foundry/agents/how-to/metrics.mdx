...
import HorzMonitorIntro from '/snippets/ai-foundry/agents/how-to/~/reusable-content/ce-skilling/azure/includes/azure-monitor/horizontals/horz-monitor-intro.mdx'
...
<Frame>
    ![](/images/ai-foundry/agents/media/monitoring/dashboard.png)
</Frame>
...
You can set alerts for any metric listed in the [monitoring data reference](../reference/monitor-service).

import HorzMonitorAdvisorRecommendations from '/snippets/ai-foundry/agents/how-to/~/reusable-content/ce-skilling/azure/includes/azure-monitor/horizontals/horz-monitor-advisor-recommendations.mdx'

<HorzMonitorAdvisorRecommendations />

## Related content

- See [Monitoring data reference](../reference/monitor-service) for a reference of the metrics and other important values created for Azure AI Foundry Agent Service.
