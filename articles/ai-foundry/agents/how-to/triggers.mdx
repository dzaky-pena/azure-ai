...
1. Click **add an action** and then search for **Azure AI Foundry Agent Service**. This will let you add connectors to your workflow.
    ...
    <Frame>
      ![](/images/ai-foundry/agents/media/triggers/connectors.png)
    </Frame>
...
<Frame>
  ![](/images/ai-foundry/agents/media/triggers/create-run.png)
</Frame>
...
1. Add the following string function to get just the response back: 
    ...
    <Frame>
      ![](/images/ai-foundry/agents/media/triggers/get-response.png)
    </Frame>
