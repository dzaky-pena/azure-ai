...
## Prerequisites
1. Ensure you've completed the prerequisites and setup steps in the [quickstart](../../quickstart).
...
1. Create a `custom keys` connection to store your API key.
    ...
    <Frame>
      ![](/images/ai-foundry/agents/media/tools/bing/project-settings-button.png)
    </Frame>
    ...
    1. Select **+ new connection** in the settings page. 
        ...
        <Frame>
            ![](/images/ai-foundry/agents/media/tools/bing/project-connections.png)
        </Frame>

   1. Select **custom keys** in **other resource types**.
    
        <Frame>
            ![](/images/ai-foundry/agents/media/tools/bing/api-key-connection.png)
        </Frame>
...
1. Enable the Azure AI Service of your agent has `system assigned managed identity` enabled.
    ...
    <Frame>
        ![](/images/ai-foundry/agents/media/tools/managed-identity-portal.png)
    </Frame>
...
1. Assign proper access to the resource.
    ...
    1. Click **Add** and then **add role assignment** at the top of the screen.
        ...
        <Frame>
            ![](/images/ai-foundry/agents/media/tools/role-assignment-portal.png)
        </Frame>
