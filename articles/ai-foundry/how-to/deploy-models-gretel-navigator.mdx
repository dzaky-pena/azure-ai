...
import ModelsPreview from '/snippets/ai-foundry/includes/models-preview.mdx'
...
**Deployment to serverless API**

Gretel Navigator chat model can be deployed to serverless API. This kind of deployment provides a way to consume models as an API without hosting them on your subscription, while keeping the enterprise security and compliance that organizations need. 

Deployment to a serverless API doesn't require quota from your subscription. If your model isn't deployed already, use the Azure AI Foundry portal, Azure Machine Learning SDK for Python, the Azure CLI, or ARM templates to [deploy the model as a serverless API](deploy-models-serverless).

> [!div class="nextstepaction"]
> [Deploy the model to serverless API](deploy-models-serverless)
...
import ContentSafetyServerlessApisNote from '/snippets/ai-foundry/includes/content-safety-serverless-apis-note.mdx'

<ContentSafetyServerlessApisNote />
...
## Cost and quota considerations for Gretel models deployed as serverless APIs
...
* [Model Inference API](../../ai-foundry/model-inference/reference/reference-model-inference-api)
* [Deploy models as serverless APIs](deploy-models-serverless)
* [Consume serverless APIs from a different Azure AI Foundry project or hub](deploy-models-serverless-connect)
* [Region availability for models in serverless APIs](deploy-models-serverless-availability)
