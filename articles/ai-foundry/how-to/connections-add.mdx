...
| Serverless Model | ✓ | Serverless Model connections allow you to [serverless API deployment](deploy-models-serverless). |
...
1. Go to your project in [Azure AI Foundry portal](https://ai.azure.com/?cid=learnDocs). If you don't have a project, [create a new project](./create-projects).
...
1. Select __+ New connection__ from the __Connected resources__ section.
    ...
    <Frame>
        ![](/images/ai-foundry/media/data-connections/connection-add.png)
    </Frame>
...
1. Select the service you want to connect to from the list of available external resources. For example, select __Azure AI Search__.
    ...
    <Frame>
        ![](/images/ai-foundry/media/data-connections/connection-add-browse-azure-ai-search.png)
    </Frame>
...
1. Browse for and select your Azure AI Search service from the list of available services and then select the type of __Authentication__ to use for the resource. Select __Add connection__.
    ...
    <Frame>
        ![](/images/ai-foundry/media/data-connections/connection-add-azure-ai-search-connect-entra-id.png)
    </Frame>
...
If your hub is configured for [network isolation](configure-managed-network), you might need to create an outbound private endpoint rule to connect to __Azure Blob Storage__, __Azure Data Lake Storage Gen2__, or __Microsoft OneLake__. A private endpoint rule is needed if one or both of the following are true:
...
- [How to create vector indexes](../how-to/index-add)
