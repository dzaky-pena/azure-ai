...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-run-list.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/learn-more-metrics.png)
</Frame>
...
import FdpBackwardCompatibilityAzureOpenai from '/snippets/ai-foundry/includes/fdp-backward-compatibility-azure-openai.mdx'

<FdpBackwardCompatibilityAzureOpenai />
...
- For **AI quality (AI Assisted)** metrics, results are aggregated by calculating an average across all the scores for each metric. If you calculate by using the **Groundedness Pro** metric, the output is binary and the aggregated score is passing rate, which is calculated by `(#trues / #instances) × 100`.
    <Frame>
        ![](/images/ai-foundry/media/evaluations/view-results/ai-quality-ai-assisted-chart.png)
    </Frame>
...
- For **Risk and safety (preview)** metrics, results are aggregated by calculating a defect rate for each metric.
  ...
  - For protected material and indirect attack, the defect rate is calculated as the percentage of instances where the output is `true` by using the formula `(Defect Rate = (#trues / #instances) × 100)`.
    <Frame>
        ![](/images/ai-foundry/media/evaluations/view-results/risk-and-safety-chart.png)
    </Frame>

- For **AI quality (NLP)** metrics, results are aggregated by calculating an average across all the scores for each metric.
    <Frame>
        ![](/images/ai-foundry/media/evaluations/view-results/ai-quality-nlp-chart.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/metrics-details-qa.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-view-json.png)
</Frame>

View the JSON in the **JSON Preview**:

<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-view-sub-evaluators.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-view-multi-turn-button.png)
</Frame>

When you select **View evaluation results per turn**, you see the following screen:

<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/metric-per-turn.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/image-per-turn-pop-up.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/image-check-blur-image.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/risk-safety-metric-human-feedback.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-log.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-list-compare.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-criteria-name-match.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-criteria-name-mismatch.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/comparison-table.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/view-results/evaluation-compare-jailbreak.png)
</Frame>
...
Understanding the built-in metrics is vital for assessing the performance and effectiveness of your AI application. By gaining insights into these key measurement tools, you're better equipped to interpret the results, make informed decisions, and fine-tune your application to achieve optimal outcomes. Refer to [Evaluation and Monitoring Metrics](../concepts/evaluation-metrics-built-in) to learn more about the following aspects:
...
- [Evaluate your generative AI apps with the Azure AI Foundry portal or SDK](../how-to/evaluate-generative-ai-app)
- [Create evaluations specifically with OpenAI evaluation graders in Azure OpenAI Hub](../openai/how-to/evaluations)

Learn more about [harm mitigation techniques](../concepts/evaluation-approach-gen-ai).
