...
The information provided in this article is specific to a **<Hub />**, and doesn't apply for a **<Fdp />**. For more information, see [Types of projects](../what-is-azure-ai-foundry.md#project-types).
</Note>
...
import MachineLearningPreviewGenericDisclaimer from '/snippets/machine-learning/includes/machine-learning-preview-generic-disclaimer.mdx'

<MachineLearningPreviewGenericDisclaimer />
