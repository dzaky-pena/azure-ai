...
import FeaturePreview from '/snippets/ai-foundry/includes/~/reusable-content/ce-skilling/azure/includes/ai-studio/includes/feature-preview.mdx'
...
1. Select the **Fine-tuning tasks** filter. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/fine-tune/fine-tune-serverless/fine-tune-filters.png)
    </Frame>
...
- [dair-ai/emotion](https://huggingface.co/datasets/dair-ai/emotion)
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/fine-tune/dataset-dair-ai-emotion.png)
    </Frame>

- [SetFit/mrpc](https://huggingface.co/datasets/SetFit/mrpc)

    <Frame>
        ![](/images/ai-foundry/media/how-to/fine-tune/dataset-setfit-mrpc.png)
    </Frame>
...
3. If you're presented the options for **serverless API deployment** and [**Managed compute**](./fine-tune-managed-compute), select **serverless API deployment** for fine-tuning. This action opens up a wizard that shows information about **Serverless API** fine-tuning for your model.
...
<Frame>
    ![](/images/ai-foundry/media/how-to/fine-tune/fine-tune-serverless/project-running.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/fine-tune/fine-tune-serverless/fine-tune-details.png)
</Frame>
...
The scenarios above should work in a Managed Vnet workspace as well. See setup of Managed Vnet AI Foundry hub here: [How to configure a managed network for Azure AI Foundry hubs](./configure-managed-network)
...
planning and managing costs with Azure AI Foundry, refer to the guidance in [Plan to manage costs for Azure AI Foundry Service](./costs-plan-manage).  
</Info>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/fine-tune/fine-tune-serverless/manage-deployments.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/deploy-monitor/serverless/costs-model-as-service-cost-details.png)
</Frame>
...
Serverless API deployment models are protected by Azure AI Content Safety. When deployed to real-time endpoints, you can opt out of this capability. With Azure AI Content Safety enabled, both the prompt and completion pass through an ensemble of classification models aimed at detecting and preventing the output of harmful content. The content filtering system detects and takes action on specific categories of potentially harmful content in both input prompts and output completions. Learn more about [Azure AI Content Safety](../concepts/content-filtering).


## Next steps
- [What is Azure AI Foundry?](../what-is-azure-ai-foundry)
- [Learn more about deploying Mistral models](./deploy-models-mistral)
