...
- An [Azure AI Foundry hub](create-azure-ai-resource), if you're using a **<Hub />**. A **<Fdp />** does not use a hub. For more information, see [Project types](../what-is-azure-ai-foundry.md#project-types).
