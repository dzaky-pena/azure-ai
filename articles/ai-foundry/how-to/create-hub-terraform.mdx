...
import AboutTerraform from '/snippets/ai-foundry/includes/~/azure-dev-docs-pr/articles/terraform/includes/abstract.mdx'
...
<Note>
The sample code for this article is located in the [Azure Terraform GitHub repo](https://github.com/Azure/terraform/tree/master/quickstart/101-azure-ai-foundry). You can view the log file containing the [test results from current and previous versions of Terraform](https://github.com/Azure/terraform/tree/master/quickstart/101-azure-ai-foundry/TestRecord). You may need to update the resource provider versions used in the template to use the latest available versions.
...
import TerraformInitMd from '/snippets/ai-foundry/includes/~/azure-dev-docs-pr/articles/terraform/includes/terraform-init.mdx'

<TerraformInitMd />

## Create a Terraform execution plan

import TerraformPlanMd from '/snippets/ai-foundry/includes/~/azure-dev-docs-pr/articles/terraform/includes/terraform-plan.mdx'

<TerraformPlanMd />

## Apply a Terraform execution plan

import TerraformApplyPlanMd from '/snippets/ai-foundry/includes/~/azure-dev-docs-pr/articles/terraform/includes/terraform-apply-plan.mdx'

<TerraformApplyPlanMd />
...
import TerraformPlanDestroyMd from '/snippets/ai-foundry/includes/~/azure-dev-docs-pr/articles/terraform/includes/terraform-plan-destroy.mdx'

<TerraformPlanDestroyMd />
