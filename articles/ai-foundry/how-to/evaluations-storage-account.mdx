...
1. Search "Storage Account" and select the Storage Account option that is published by Microsoft.
    ...
    <Frame>
        ![](/images/ai-foundry/media/evaluations/storage/storage-account.png)
    </Frame>
...
1. Select **Storage account**.
     <Frame>
        ![](/images/ai-foundry/media/evaluations/storage/add-storage-account.png)
     </Frame>
...
1. Select +Add -> Add role assignment.
    ...
    <Frame>
        ![](/images/ai-foundry/media/evaluations/storage/access-control.png)
    </Frame>
...
- [Run evaluations in the cloud](./develop/cloud-evaluation)
