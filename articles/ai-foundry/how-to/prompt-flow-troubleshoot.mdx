...
<Frame>
    ![](/images/ai-foundry/media/prompt-flow/view-full-output.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/prompt-flow/trace-large-language-model-tool.png)
</Frame>

### How do I fix a 429 error from Azure OpenAI?

You might encounter a 429 error from Azure OpenAI. This error means that you reached the rate limit of Azure OpenAI. You can check the error message in the output section of the LLM node. To learn more about the rate limit, see [Azure OpenAI rate limit](../openai/quotas-limits).

<Frame>
    ![](/images/ai-foundry/media/prompt-flow/429-rate-limit.png)
</Frame>
...
1. Try to find the following warning log format: `<node_name> has been running for <duration> seconds`.
   ...
   - **Case 1:** Python script node runs for a long time.
        ...
        <Frame>
          ![](/images/ai-foundry/media/prompt-flow/runtime-timeout-running-for-long-time.png)
        </Frame>
   ...
   - **Case 2:** The LLM node runs for a long time.
        ...
        <Frame>
          ![](/images/ai-foundry/media/prompt-flow/runtime-timeout-by-language-model-timeout.png)
        </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/prompt-flow/unable-to-fetch-deployment-schema.png)
</Frame>
