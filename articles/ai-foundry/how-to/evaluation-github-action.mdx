...
Foundry project or Hubs based project. To learn more, see [Create a project](create-projects).
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/github-action-multi-agent-result.png)
</Frame>

Single agent evaluation result:

<Frame>
    ![](/images/ai-foundry/media/evaluations/github-action-single-agent-output.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/evaluations/github-action-output-results.png)
</Frame>
