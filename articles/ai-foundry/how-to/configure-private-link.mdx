...
When using a [!INCLUDE [fdp-projects](../includes/fdp-project-name)], you can use a private link to secure communication with your project. This article describes how to establish a private connection to your project using a private link.

</Tab>

<Tab title="Hub based project">

When using a [!INCLUDE [hub-projects](../includes/hub-project-name)], there are two network isolation aspects to consider:
...
When creating a Foundry resource and [!INCLUDE [fdp-projects](../includes/fdp-project-name)] to build Agents, we recommend the following network architecture for the most secure end-to-end configuration:
...
- There's no managed virtual network support for the Agent Service or [!INCLUDE [FDP](../includes/fdp-project-name)].
