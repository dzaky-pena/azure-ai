...
- [Manage and increase quotas for resources with Azure AI Foundry](quota)
...
[!INCLUDE [uses-hub-only](../includes/uses-hub-only)]
...
- [Azure AI Foundry overview](../what-is-azure-ai-foundry)
