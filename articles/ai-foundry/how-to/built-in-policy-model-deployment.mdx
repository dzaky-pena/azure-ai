...
<Tip>
The steps in this article govern the deployment of MaaS and MaaP models for both a [!INCLUDE [fdp](../includes/fdp-project-name)] and [!INCLUDE [hub](../includes/hub-project-name)].
</Tip>
...
1. In the **Parameters** tab, deselect **Only show parameters that needs input or review** to see all fields:
    ...
    - **Allowed Asset Ids**: This field expects a list of **model asset ids** in quotation and separated by commas.
        ...
        1. Go to the [Azure AI Foundry model catalog](model-catalog-overview).
...
- [Azure AI Foundry model catalog](model-catalog-overview)
