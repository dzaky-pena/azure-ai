...
- Prompt flow requires a compute session. If you don't have a runtime, you can [create one in Azure AI Foundry portal](./create-manage-compute-session).
...
1. On the **Create a new flow** page, enter a folder name and then select **Create**.
    ...
    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-standard-flow.png)
    </Frame>
...
1. You can start authoring your flow now. By default you see a sample flow. This example flow has nodes for the LLM and Python tools. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-in-out.png)
    </Frame>
...
1. Optionally, you can add more tools to the flow. The visible tool options are **LLM**, **Prompt**, and **Python**. To view more tools, select **+ More tools**. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-more-tools.png)
    </Frame>

1. Select a connection and deployment in the LLM tool editor.

    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-connection.png)
    </Frame>
...
1. Select **Run** to run the flow. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-run.png)
    </Frame>

1. The flow run status is shown as **Running**. 

    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-running.png)
    </Frame>

1. Once the flow run is completed, select **View outputs** to view the flow results.

    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-outputs-view.png)
    </Frame>

1. You can view the flow run status and output in the **Outputs** section.

    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/create-flow-outputs-view-joke.png)
    </Frame>
...
- Run **single node**.
    ...
    <Frame>
        ![](/images/ai-foundry/media/prompt-flow/node-card-run.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/prompt-flow/authoring-test-result.png)
</Frame>
...
- [Batch run using more data and evaluate the flow performance](./flow-bulk-test-evaluation)
