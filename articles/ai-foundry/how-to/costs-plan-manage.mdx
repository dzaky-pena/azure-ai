...
1. Select a product such as Azure OpenAI in the Azure pricing calculator.
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/pricing-calculator-select-product.png)
    </Frame>

1. Enter the number of units you plan to use. For example, enter the number of tokens for prompts and completions.

    <Frame>
        ![](/images/ai-foundry/media/cost-management/pricing-calculator-estimate-openai.png)
    </Frame>
...
1. You can select more than one product to estimate costs for multiple products. For example, select Virtual Machines to add potential costs for compute resources.
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/pricing-calculator-estimate.png)
    </Frame>
...
1. Select **View cost for resources** from the **Total cost** section. The [Azure portal](https://portal.azure.com) opens to the resource group for your project.
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/project-settings-go-view-costs.png)
    </Frame>

1. Expand the **Resource** column to see the costs for each service that's underlying your [project](../concepts/ai-resources). But this view doesn't include costs for all resources that you use in a project.

    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/costs-per-project-resource.png)
    </Frame>

1. Select **Costs by resource** > **Resources**.

    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/select-costs-per-resource.png)
    </Frame>

1. On the **Cost analysis** page where you're taken to, make sure the scope is set to your resource group. 

    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/costs-per-resource-group-details.png)
    </Frame>
    ...
    - The costs that are limited to resources and services in the example [project](../concepts/ai-resources) total **$212.06**. 
    
1. Expand **contoso-outdoor-proj** to see the costs for services underlying the [project](../concepts/ai-resources) resource. 

    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/costs-per-project-resource-details.png)
    </Frame>

1. Expand **contoso_ai_resource** to see the costs for services underlying the [hub](../concepts/ai-resources) resource. You can also apply a filter to focus on other costs in your resource group. 
...
1. From the left pane, select **Cost analysis**.
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/project-costs/costs-per-resource-group.png)
    </Frame>
...
1. Select a view such as **Resources**. The cost associated with each resource is displayed.
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/marketplace/costs-model-as-service-cost-analysis.png)
    </Frame>
...
1. On the **Type** column, select the filter icon to filter all the resources of type **microsoft.saas/resources**. This type corresponds to resources created from offers from the Azure Marketplace. For convenience, you can filter by resource types containing the string **SaaS**. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/marketplace/costs-model-as-service-cost-filter.png)
    </Frame>
...
1. Select to expand the resource details to get access to each of the costs meters associated with the resource. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/cost-management/marketplace/costs-model-as-service-cost-details.png)
    </Frame>
