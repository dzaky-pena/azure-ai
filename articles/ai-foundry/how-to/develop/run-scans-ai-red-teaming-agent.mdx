...
- An Azure AI Foundry project or hubs based project. To learn more, see [Create a project](../create-projects).
...
Once your AI red teaming scan is finished running, you can [view your results](../view-ai-red-teaming-results) in your Azure AI Foundry project.
