...
- Either a [[!INCLUDE [fdp-project-name](../../includes/fdp-project-name)]](../create-projects.md?pivots=fdp-project) or a [[!INCLUDE [hub-project-name](../../includes/hub-project-name)]](../create-projects.md?pivots=hub-project).
...
- [Get started building a chat app using the Azure AI Foundry SDK](../../quickstarts/get-started-code)
