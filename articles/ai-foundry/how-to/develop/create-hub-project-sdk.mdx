...
<Note>
A hub is used only for a **[!INCLUDE [hub](../../includes/hub-project-name)]**. A **[!INCLUDE [fdp](../../includes/fdp-project-name)]** does not use a hub. For more information, see [Types of projects](../../what-is-azure-ai-foundry.md#project-types).
</Note>
...
After creating your own [AI Foundry resource](../../../ai-services/multi-service-resource.md?context=%2Fazure%2Fai-foundry%2Fcontext%2Fcontext) or [Azure OpenAI resource](../../openai/how-to/create-resource) in the same resource group, you can connect it to your hub. You can also connect [Azure AI Search](../../../search/search-create-service-portal) from any resource group in your same subscription.
