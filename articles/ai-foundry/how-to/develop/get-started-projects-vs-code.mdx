...
- Your subscription needs to be below your [quota limit](../quota) to [deploy a new model in this quickstart](#deploy-a-model-from-the-model-catalog). Otherwise you already need to have a [deployed chat model](../deploy-models-openai).
...
For a full list of features available in the extension, use the Command Palette. Select <kbd>F1</kbd> to open the command palette and search **Azure AI Foundry**. The following screenshot shows some of the actions for Azure AI Foundry.
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/visual-studio-command-palette-small.png)
    </Frame>
...
1. Sign in by selecting the `Sign in to Azure...` item in the **Azure Resources** view.
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/sign-in-to-azure-resources.png)
    </Frame>
...
1. Select **Open in Azure AI Foundry Extension**.
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/open-azure-ai-foundry-extension.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/initial-view.png)
</Frame>
...
<Note>
    To learn more about working with Agents and Threads in the Azure AI Foundry Extension, see the [Work with Azure AI Foundry Agent Service in Visual Studio Code](./vs-code-agents) article. 
</Note>
...
1. In the top center, enter the Azure AI Foundry Project name to use in the **Enter project name** textbox and press Enter.
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/enter-project-name.png)
    </Frame>
...
- To create a new resource group:
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/select-resource-group.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/project-deployed.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/default-project.png)
</Frame>
...
1. The **Model Catalog** page is displayed.
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/display-model-catalog.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/select-model-plus-expanded.png)
</Frame>
...
1. After a successful deployment, your model will be listed by deployment name with your other deployed models under the **Models** section in your project.  
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/deployed-model.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/select-model-caret.png)
</Frame>

The expanded **Models** section displays the list of deployed models.

<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/select-model-caret-expanded.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/enter-agent-name.png)
</Frame>

Update the desired editable fields such as rate limit directly within VS Code.

<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/save-model-changes.png)
</Frame>
...
1. Right-click on your deployed model and select the **Open code file** option. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/open-code-file.png)
    </Frame>

1. In the top center, select your preferred SDK to use in the **Choose preferred SDK** dropdown and press Enter.

    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/choose-preferred-sdk.png)
    </Frame>

1. In the top center, select your preferred language to use in the **Choose language** dropdown and press Enter.

    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/choose-language.png)
    </Frame>
...
1. In the top center, select your preferred authentication method to use in the **Choose authentication method** dropdown and press Enter.
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/choose-auth-method.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/sample-code-file.png)
</Frame>
...
1. Right-click on your deployed model and select the **Open in playground** option. 
    ...
    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/open-playground.png)
    </Frame>

1. The **Playground** page is displayed.

    <Frame>
        ![](/images/ai-foundry/media/how-to/get-started-projects-vs-code/display-playground.png)
    </Frame>
...
- Learn about [working with the Azure AI Foundry Agent Service](./vs-code-agents) using this Visual Studio Code extension.