...
- _Premium models_: These include [Mistral Large, Mistral Small, Mistral-OCR-2503, Mistral Medium 3 (25.05), and Ministral 3B models](deploy-models-mistral) models, and are available as serverless API with pay-as-you-go billing.  
- _Open models_: These include [Codestral](deploy-models-mistral-codestral) and [Mistral Nemo](deploy-models-mistral-nemo) (that are available as serverless API deployments), and Mixtral-8x7B-Instruct-v01, Mixtral-8x7B-v01, Mistral-7B-Instruct-v01, and Mistral-7B-v01 (that are available to download and run on self-hosted managed endpoints).
...
> [Deploy the model to managed compute](../concepts/deployments-overview)
...
* [Consume serverless API endpoints from a different Azure AI Foundry project or hub](deploy-models-serverless-connect)
* [Region availability for models in serverless API](deploy-models-serverless-availability)
