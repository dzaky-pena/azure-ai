...
The information in this article only applies to a **<Hub />**. A **<Fdp />** isn't supported. For more information, see [Types of projects](../what-is-azure-ai-foundry.md#project-types).
</Note>
