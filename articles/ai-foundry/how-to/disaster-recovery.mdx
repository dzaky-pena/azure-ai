...
<Note>
The information in this article only applies to a **[!INCLUDE [hub](../includes/hub-project-name)]**. A **[!INCLUDE [fdp](../includes/fdp-project-name)]** isn't supported. For more information, see [Types of projects](../what-is-azure-ai-foundry.md#project-types).
</Note>
...
* To learn about secure infrastructure deployments with Azure AI Foundry, see [Create a secure hub](create-secure-ai-hub).
