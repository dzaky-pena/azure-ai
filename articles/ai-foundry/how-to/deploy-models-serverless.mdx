...
import DeployModelsToFoundryResources from '/snippets/ai-foundry/includes/deploy-models-to-foundry-resources.mdx'

<DeployModelsToFoundryResources />
...
- If you don't have one, [create a <Hub />](create-projects).
