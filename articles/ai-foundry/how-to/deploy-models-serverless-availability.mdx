...
import RegionAvailabilityMaas from '/snippets/ai-foundry/includes/region-availability-maas.mdx'

<RegionAvailabilityMaas />
...
Read [Consume serverless APIs from a different hub or project](deploy-models-serverless-connect) to learn how to configure an existing serverless API deployment in a different hub or project than the one where it was deployed.

## Related content

- [Model Catalog and Collections](model-catalog-overview)
- [Deploy models as serverless API](deploy-models-serverless)
