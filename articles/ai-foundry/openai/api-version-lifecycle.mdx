...
- [**NEW** v1 Preview API](reference-preview-latest)
- Inference: [2025-04-01-preview](reference-preview)
...
- [Computer use](./how-to/computer-use)
...
- `store`, and `metadata` parameters added for [stored completions support](./how-to/stored-completions).
...
Azure OpenAI API version [2024-10-21](./reference) is currently the latest GA API release. This API version is the replacement for the previous `2024-06-01` GA API release.
...
- [Learn about working with Azure OpenAI models](./how-to/working-with-models)
