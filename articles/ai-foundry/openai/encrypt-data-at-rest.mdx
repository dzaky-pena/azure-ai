...
1. Under **Key permissions**, select **Get**, **Wrap Key**, and **Unwrap Key**. Leave the remaining checkboxes unselected.
   ...
   <Frame>
      ![](/images/ai-services/media/cognitive-services-encryption/key-vault-access-policy.png)
   </Frame>
...
1. Copy the **Key Identifier** value, which provides the URI.
   ...
   <Frame>
      ![](/images/ai-services/media/cognitive-services-encryption/key-uri-portal.png)
   </Frame>
...
1. Paste the URI that you copied into the **Key URI** box.
   ...
   <Frame>
      ![](/images/ai-services/media/cognitive-services-encryption/ssecmk2.png)
   </Frame>
...
1. Select the key that you want to use.
   ...
   <Frame>
      ![](/images/ai-services/media/cognitive-services-encryption/ssecmk3.png)
   </Frame>
1. Save your changes.
