...
1. Under **Key permissions**, select **Get**, **Wrap Key**, and **Unwrap Key**. Leave the remaining checkboxes unselected.
   ...
   :::image source="../../ai-services/media/cognitive-services-encryption/key-vault-access-policy.png" alt-text="Screenshot of the Azure portal page for a key vault access policy. The permissions selected are Get Key, Wrap Key, and Unwrap Key.":::
   <Frame>
      ![](TODO : Images)
   </Frame>
...
1. Copy the **Key Identifier** value, which provides the URI.
   ...
   :::image source="../../ai-services/media/cognitive-services-encryption/key-uri-portal.png" alt-text="Screenshot of the Azure portal page for a key version. The Key Identifier box contains a placeholder for a key URI.":::
   <Frame>
      ![](TODO : Images)
   </Frame>
...
1. Paste the URI that you copied into the **Key URI** box.
   ...
   :::image source="../../ai-services/media/cognitive-services-encryption/ssecmk2.png" alt-text="Screenshot of the Encryption page for an Azure OpenAI resource. The Enter key URI option is selected, and the Key URI box contains a value.":::
   <Frame>
      ![](TODO : Images)
   </Frame>
...
1. Select the key that you want to use.
   ...
   :::image source="../../ai-services/media/cognitive-services-encryption/ssecmk3.png" alt-text="Screenshot of the Select key from Azure Key Vault page in the Azure portal. The Subscription, Key vault, Key, and Version boxes contain values.":::
   <Frame>
      ![](TODO : Images)
   </Frame>
1. Save your changes.
