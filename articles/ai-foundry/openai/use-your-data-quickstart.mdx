...
import ConnectYourDataToOpenai from '/snippets/ai-foundry/openai/includes/connect-your-data-studio.mdx'
import PythonQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-python.mdx'
import StudioQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-studio.mdx'
...
import CsharpQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-dotnet.mdx'
...
import SpringQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-spring.mdx'
...
import JavascriptQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-javascript.mdx'
...
import TypescriptQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-typescript.mdx'
...
import PowershellQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-powershell.mdx'
...
import GoQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-go.mdx'
...
import RestApiQuickstart from '/snippets/ai-foundry/openai/includes/use-your-data-rest.mdx'
...
- Learn more about [using your data in Azure OpenAI in Azure AI Foundry Models](./concepts/use-your-data)
