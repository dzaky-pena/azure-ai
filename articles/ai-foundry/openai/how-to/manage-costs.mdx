...
Azure OpenAI chat completions model inference is [charged per 1,000 tokens with different rates](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/) depending on model and [deployment type](./deployment-types). For most models pricing is now listed in terms of 1 million tokens.
...
<Frame>
    ![](/images/ai-foundry/openai/media/manage-costs/resource-view.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/manage-costs/grouping.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/manage-costs/cost-analyzer.png)
</Frame>

The cost analysis dashboard shows the accumulated costs that are analyzed depending on what you've specified for **Scope**.

<Frame>
    ![](/images/ai-foundry/openai/media/manage-costs/subscription.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/manage-costs/service-tier.png)
</Frame>
