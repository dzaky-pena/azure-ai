---
title: "'How to use the GPT-4o Realtime API for speech and audio with Azure OpenAI' in Azure AI Foundry Models"
...
- For steps to deploy and use the `gpt-4o-realtime-preview` or `gpt-4o-mini-realtime-preview` model, see [the real-time audio quickstart](../realtime-audio-quickstart).
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/real-time/input-audio-buffer-client-managed.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/real-time/input-audio-buffer-server-vad.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/real-time/conversation-item-sequence.png)
</Frame>
