...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/reinforcement-fine-tuning/model.png)
</Frame>

<Frame>
    ![](/images/ai-foundry/openai/media/how-to/reinforcement-fine-tuning/reinforcement.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/reinforcement-fine-tuning/grader-schema.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/reinforcement-fine-tuning/pause.png)
</Frame>
...
You can deploy the fine tuning job which is completed or any intermittent checkpoints created automatically or manually by triggering pause operation. To know more about model deployment and test with Chat Playground refer, see [fine-tuning deployment](./fine-tuning-deploy).
