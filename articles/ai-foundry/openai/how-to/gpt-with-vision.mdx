---
title: "How to use vision-enabled chat models in Azure AI Foundry Models"
description: Learn how to use vision-enabled chat models in Azure OpenAI, including how to call the Chat Completion API and process images. #dereklegenzoff #delegenz
...
Vision-enabled chat models are large multimodal models (LMM) developed by OpenAI that can analyze images and provide textual responses to questions about them. They incorporate both natural language processing and visual understanding. The current vision-enabled models are the [o-series reasoning models](./reasoning), GPT-4.1 series models, GPT-4.5, GPT-4o series, and GPT-4 Turbo with Vision.
