...
2. Select **Associated Resources** from the left-hand menu.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/associated-resources-selection.png)
    </Frame>

3. Select **Add** > **Associate resources with an existing profile**.

    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/add-associated-resources.png)
    </Frame>
...
5. Select **Associate**, and then select the Azure OpenAI service you created.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/associate-with-profile.png)
    </Frame>
...
4. Select the three dots in the far right of the Azure OpenAI service row. Select **Change access mode** in the popup.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/change-access-mode.png)
    </Frame>

5. Select the desired access mode and select Apply.

    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/apply-access-mode.png)
    </Frame>
...
2. Select **Diagnostic settings** in the left-hand menu.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/diagnostic-settings.png)
    </Frame>
...
6. Under Destination details, select Archive to a storage account or Send to Log Analytics workspace. The storage account must be in the same region as the network security perimeter. You can either use an existing storage account or create a new one. A Log Analytics workspace can be in a different region than the one used by the network security perimeter. You can also select any of the other applicable destinations.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/log-categories.png)
    </Frame>
...
2. Select **Profiles** in the left-hand menu.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/profiles-selector.png)
    </Frame>
...
3. Select the profile you're using with your network security perimeter.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/selected-profile.png)
    </Frame>

4. Select **Inbound access rules** in the left-hand menu.

    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/inbound-network-navigation.png)
    </Frame>

5. Select **Add**.

    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/add-rule.png)
    </Frame>
...
7. Select **Add** to create the inbound access rule.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/add-rule-2.png)
    </Frame>
...
4. Select **Outbound access rules** in the left-hand menu.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/outbound-network-navigation.png)
    </Frame>

5. Select **Add**.

    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/add-outbound.png)
    </Frame>
...
7. Select **Add** to create the outbound access rule.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/network-security-perimeter/add-outbound-2.png)
    </Frame>
...
- [Role-based access control for Azure OpenAI](./role-based-access-control)
