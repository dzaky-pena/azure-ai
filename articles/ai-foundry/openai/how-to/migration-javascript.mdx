---
title: "How to migrate to OpenAI JavaScript v4.x in Azure AI Foundry Models"
...
There are several ways to authenticate API requests to Azure OpenAI. We highly recommend using Microsoft Entra ID tokens. See the [Azure Identity documentation](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/README) for more information.
...
- [Azure OpenAI Assistants](../concepts/assistants)
