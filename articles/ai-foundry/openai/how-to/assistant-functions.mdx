...
* You can also perform function calling [with Azure Logic apps](./assistants-logic-apps)
</Note>
...
* Learn more about how to use Assistants with our [How-to guide on Assistants](../how-to/assistant).
