...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/fine-tuning-deploy/deploy-dialogue.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/fine-tuning/global-standard.png)
</Frame>
...
- [Azure OpenAI Quotas & limits](./quota)
- [Azure OpenAI deployment types](./deployment-types)
