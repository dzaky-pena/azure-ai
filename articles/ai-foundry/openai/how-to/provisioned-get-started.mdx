...
* [Azure AI Foundry Provisioned Throughput Onboarding Guide](./provisioned-throughput-onboarding)
* [Azure AI Foundry Provisioned Throughput Concepts](../concepts/provisioned-throughput) 
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/available-quota.png)
</Frame>
...
Provisioned deployments are created via Azure AI Foundry resource objects within Azure. You must have an Azure AI Foundry resource in each region where you intend to create a deployment. Use the Azure portal to [create a resource](./create-resource) in a region with available quota, if required.  
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/deployment-screen.png)
</Frame>
...
| Content filter    | Specify the filtering policy to apply to the deployment. Learn more on our [Content Filtering](../concepts/content-filter) how-to. |     Default |
...
* [Understanding the provisioned throughput costs](provisioned-throughput-onboarding) 

The image below shows the pricing confirmation you will see. The price shown is an example only. 

<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/confirm-pricing.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/deployment-screen-2.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/choose-different-resource.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/deepseek-deployment.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/fungible-quota.png)
</Frame>
...
* [Azure AI Foundry provisioned throughput onboarding guide](./provisioned-throughput-onboarding) 
* [Guide for Azure AI Foundry provisioned throughput reservations](../concepts/provisioned-throughput) 
...
The inferencing code for provisioned deployments is the same a standard deployment type. The following code snippet shows a chat completions call to a GPT-4 model. For your first time using these models programmatically, we recommend starting with our [quickstart guide](../quickstart). Our recommendation is to use the OpenAI library with version 1.0 or greater since this includes retry logic within the library.
...
<Frame>
    ![](/images/ai-foundry/openai/media/provisioned/azure-monitor-utilization.jpg)
</Frame>

For more information about monitoring your deployments, see the [Monitoring Azure OpenAI](./monitor-openai) page.
...
* For more information on provisioned deployments, check out [What is provisioned throughput?](../concepts/provisioned-throughput)
