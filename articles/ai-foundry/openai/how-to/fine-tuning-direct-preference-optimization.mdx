...
## How to use direct preference optimization fine-tuning
   ...
   :::image border="true" source="/azure/ai-services/openai/media/fine-tuning/preference-optimization.gif" alt-text="GIF of preference optimization fine-tuning steps.":::
  <Frame>
      ![](TODO : Images)
  </Frame>
