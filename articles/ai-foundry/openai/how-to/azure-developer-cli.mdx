---
title: "'Use the Azure Developer CLI to deploy resources for Azure OpenAI On Your Data' in Azure AI Foundry Models"
...
After you run the `azd` template and upload your data, you're ready to start using Azure OpenAI On Your Data. For code samples that you can use to build your applications, see the [quickstart article](../use-your-data-quickstart).
