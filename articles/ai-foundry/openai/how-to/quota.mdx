...
<Frame>
    ![](/images/ai-foundry/openai/media/quota/deployment-new.png)
</Frame>
...
<Info>
Quotas and limits are subject to change, for the most up-date-information consult our [quotas and limits article](../quotas-limits).
</Info>
...
<Note>
Quota Tokens-Per-Minute (TPM) allocation isn't related to the max input token limit of a model. Model input token limits are defined in the [models table](../concepts/models) and aren't impacted by changes made to TPM.  
</Note>
...
<Frame>
    ![](/images/ai-foundry/openai/media/quota/quota-new.png)
</Frame>
...
|capacity|integer|This represents the amount of [quota](../how-to/quota) you're assigning to this deployment. A value of 1 equals 1,000 Tokens per Minute (TPM). A value of 10 equals 10k Tokens per Minute (TPM).|
...
- To review quota defaults for Azure OpenAI, consult the [quotas & limits article](../quotas-limits)
