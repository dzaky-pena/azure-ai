...
- An Azure OpenAI resource with a model of the deployment type `Global-Batch` or `DataZoneBatch` deployed. You can refer to the [resource creation and model deployment guide](./create-resource) for help with this process.
...
2. Find your Azure OpenAI resource > Select **Resource Management** > **Identity** > **System assigned** > set status to **On**.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/how-to/batch-blob-storage/identity.png)
    </Frame>
...
2. Select **Access Control (IAM)** > **Add** > **Add role assignment**.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/how-to/batch-blob-storage/access-control.png)
    </Frame>
...
4. Select **Managed identity** > **+Select members** > Select your Azure OpenAI resources's managed identity.
    ...
    <Frame>
        ![](/images/ai-foundry/openai/media/how-to/batch-blob-storage/add-role.png)
    </Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/batch-blob-storage/container.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/how-to/batch-blob-storage/upload.png)
</Frame>
...
You can monitor the status the same way you would previously as outlined in our [comprehensive guide on using Azure OpenAI batch](./batch).
...
For more information on Azure OpenAI Batch, see the [comprehensive batch guide](./batch).
