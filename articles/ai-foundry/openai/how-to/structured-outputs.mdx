...
import StructuredOutputsPython from '/snippets/ai-foundry/openai/includes/structured-outputs-python.mdx'

<StructuredOutputsPython />
...
import StructuredOutputsDotnet from '/snippets/ai-foundry/openai/includes/structured-outputs-dotnet.mdx'

<StructuredOutputsDotnet />
...
import StructuredOutputsRest from '/snippets/ai-foundry/openai/includes/structured-outputs-rest.mdx'

<StructuredOutputsRest />
