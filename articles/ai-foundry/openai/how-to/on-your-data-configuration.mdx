...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/ingestion-architecture.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/inference-architecture.png)
</Frame>
...
[!INCLUDE [Azure Key Vault](~/reusable-content/ce-skilling/azure/includes/ai-services/security/azure-key-vault)]
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/virtual-network.png)
</Frame>
...
To allow your Azure AI Search and Storage Account to recognize your Azure OpenAI in Azure AI Foundry Models via Microsoft Entra ID authentication, you need to assign a managed identity for your Azure OpenAI in Azure AI Foundry Models. The easiest way is to toggle on system assigned managed identity on Azure portal.

<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/openai-managed-identity.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/outbound-managed-identity-ai-search.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/managed-identity-ai-search.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/search-trusted-service.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/ingestion-architecture-s2.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/vpn-client.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/web-app-configure-outbound-traffic.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/api-local-test-setup-credential.png)
</Frame>
...
See the [inference API reference article](../references/on-your-data) for details on the request and response objects used by the inference API.
...
<Frame>
    ![](/images/ai-foundry/openai/media/use-your-data/defender.png)
</Frame>
