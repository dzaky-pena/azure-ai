...
[!INCLUDE [Global batch](../includes/model-matrix/global-batch)]
...
[!INCLUDE [Data zone batch](../includes/model-matrix/global-batch-datazone)]
...
[!INCLUDE [Azure AI Foundry portal](../includes/batch/batch-studio)]

</Tab>

<Tab title="Python">

[!INCLUDE [Python](../includes/batch/batch-python)]

</Tab>

<Tab title="REST API">

[!INCLUDE [REST](../includes/batch/batch-rest)]

</Tab>

[!INCLUDE [Quota](../includes/global-batch-limits)]
