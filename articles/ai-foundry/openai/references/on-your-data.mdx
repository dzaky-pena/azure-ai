...
<Note>
[Pinecone](./pinecone), and [Elasticsearch](./elasticsearch) are supported as a preview.
</Note>
...
* [Azure Cosmos DB for MongoDB vCore](./cosmos-db)
* [Elasticsearch (preview)](./elasticsearch)
* [Pinecone (preview)](./pinecone)
