...
| --- | --- |
| Models available | [o4-mini & o3](./how-to/reasoning) <br/>[gpt-4.1](./concepts/models.md#gpt-41-series) <br/> [**computer-use-preview**](./concepts/models.md#computer-use-preview)<br/>[**o3-mini & o1**](./how-to/reasoning) <br/>[**o1-mini**](./how-to/reasoning)<br/>**GPT-4o & GPT-4o mini**<br/> **GPT-4 series (including GPT-4 Turbo with Vision)** <br/>**GPT-3.5-Turbo series**<br/> Embeddings series <br/> Learn more in our [Models](./concepts/models) page.|
...
| Model regional availability | [Model availability](./concepts/models) |
...
Start with the [Create and deploy an Azure OpenAI resource](./how-to/create-resource) guide.
...
1. When you have a deployed model, you can:
    ...
    For example, you can try [real-time audio](./realtime-audio-quickstart) in the playgrounds or via code.
...
Azure OpenAI is a new product offering on Azure. You can get started with Azure OpenAI the same way as any other Azure product where you [create a resource](how-to/create-resource), or instance of the service, in your Azure Subscription. You can read more about Azure's [resource management design](/azure/azure-resource-manager/management/overview).
...
While these models are powerful, their behavior is also sensitive to the prompt. This makes [prompt engineering](./concepts/prompt-engineering) an important skill to develop.
...
Learn more about each model on our [models concept page](./concepts/models).
