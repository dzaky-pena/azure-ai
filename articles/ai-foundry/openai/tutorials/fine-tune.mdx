...
- An Azure OpenAI resource in a [region where `gpt-4o-mini-2024-07-18` fine-tuning is available](../concepts/models). If you don't have a resource the process of creating one is documented in our resource [deployment guide](../how-to/create-resource).
- Fine-tuning access requires **Cognitive Services OpenAI Contributor**.
- If you don't already have access to view quota and deploy models in [Azure AI Foundry portal](https://ai.azure.com/?cid=learnDocs), then you need [more permissions](../how-to/role-based-access-control).
...
[!INCLUDE [get-key-endpoint](../includes/get-key-endpoint)]
...
[!INCLUDE [Fine-tuning deletion](../includes/fine-tune)]
...
- Learn more about [fine-tuning in Azure OpenAI](../how-to/fine-tuning)
