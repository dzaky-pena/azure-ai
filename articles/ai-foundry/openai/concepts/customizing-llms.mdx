...
- [System messages](./advanced-prompt-engineering)
...
- RAG is helpful when you might want questions answered that are recent (for example, before the cutoff date of when the [model version](./models) was last trained).

### Getting started

- [Retrieval Augmented Generation in Azure AI Foundry portal](../../../ai-foundry/concepts/retrieval-augmented-generation)
...
- [When to use Azure OpenAI fine-tuning](./fine-tuning-considerations)
- [Customize a model with fine-tuning](../how-to/fine-tuning)
- [Azure OpenAI GPT-4o Turbo fine-tuning tutorial](../tutorials/fine-tune)
