...
<Note>
The following upgrade guidance only applies to Standard deployment types. For guidance on updating or migrating provisioned deployment types, review the [model management documentation](../how-to/working-with-models).
</Note>
...
* Read [what’s new](../whats-new) and [models](../concepts/models) to understand the changes and new features.
* Read the documentation on [model deployments](../how-to/create-resource) and [version upgrades](../how-to/working-with-models) to understand how to work with model versions.
