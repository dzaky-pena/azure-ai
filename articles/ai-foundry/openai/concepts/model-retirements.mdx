...
For information on the model upgrade process, see [How to upgrade to a new model or version](./model-versions).
...
import ModelRetirementTable from '/snippets/ai-foundry/openai/includes/retirement/models.mdx'

<ModelRetirementTable />

## Retirement and deprecation history

To track individual updates to this article refer to the [Git History](https://github.com/MicrosoftDocs/azure-ai-docs/commits/main/articles/ai-services/openai/includes/retirement/models)
