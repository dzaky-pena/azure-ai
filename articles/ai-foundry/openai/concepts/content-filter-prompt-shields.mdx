...
import PromptShieldAttackInfo from '/snippets/ai-services/content-safety/includes/prompt-shield-attack-info.mdx'

<PromptShieldAttackInfo />
...
Spotlighting is turned off by default, and users can enable it when [configuring their content filter](../how-to/content-filters) in the Azure AI Foundry portal or REST API.
