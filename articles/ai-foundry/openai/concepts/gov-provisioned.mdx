...
* [Azure OpenAI Provisioned Concepts](./provisioned-throughput)
* [Getting started using provisioned deployments on the Azure OpenAI in Azure AI Foundry Models](../how-to/provisioned-get-started)
* [Azure OpenAI Provisioned Onboarding Guide](../how-to/provisioned-throughput-onboarding)
