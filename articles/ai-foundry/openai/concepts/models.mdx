...
[!INCLUDE [Standard Global](../includes/model-matrix/standard-global)]
...
[!INCLUDE [Data zone standard](../includes/model-matrix/datazone-standard)]
...
[!INCLUDE [Standard Models](../includes/model-matrix/standard-models)]
...
[!INCLUDE [Chat Completions](../includes/model-matrix/standard-chat-completions)]
...
[!INCLUDE [Embeddings](../includes/model-matrix/standard-embeddings)]
...
[!INCLUDE [Image Generation](../includes/model-matrix/standard-image-generation)]
...
[!INCLUDE [Audio](../includes/model-matrix/standard-audio)]

# [Completions (Legacy)](#tab/standard-completions)

### Completions models

[!INCLUDE [Completions](../includes/model-matrix/standard-completions)]

---

## Fine-tuning models

[!INCLUDE [Fine-tune models](../includes/fine-tune-models)]
