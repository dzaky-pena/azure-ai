...
import PromptChatCompletion from '/snippets/ai-foundry/openai/includes/prompt-chat-completion.mdx'

<PromptChatCompletion />

#### [Completion APIs](#tab/completion)

import PromptCompletion from '/snippets/ai-foundry/openai/includes/prompt-completion.mdx'
...
<Frame>
    ![](/images/ai-foundry/openai/media/prompt-engineering/space-efficiency.png)
</Frame>
...
* Get started with the ChatGPT model with [the ChatGPT quickstart](../chatgpt-quickstart).
