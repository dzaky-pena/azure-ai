...
In this tutorial, you use the [Azure AI Foundry](https://ai.azure.com/?cid=learnDocs) SDK (and other libraries) to  evaluate the chat app you built in [Part 2 of the tutorial series](copilot-sdk-build-rag). In this part three, you learn how to:
...
[!INCLUDE [hub-only-tutorial](../includes/hub-only-tutorial)]

- Complete [part 2 of the tutorial series](copilot-sdk-build-rag) to build the chat application.

- Use the same **[!INCLUDE [hub](../includes/hub-project-name)]** you created in part 1. 
...
<Frame>
    ![](/images/ai-foundry/media/tutorials/develop-rag-copilot-sdk/eval-studio-overview.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/media/tutorials/develop-rag-copilot-sdk/eval-studio-rows.png)
</Frame>

For more information about evaluation results in Azure AI Foundry portal, see [How to view evaluation results in Azure AI Foundry portal](../how-to/evaluate-results).
...
- [Learn more about the Azure AI Foundry SDK](../how-to/develop/sdk-overview)
