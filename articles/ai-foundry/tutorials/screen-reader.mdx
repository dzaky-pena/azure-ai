...
import HubProjectName from '/snippets/ai-foundry/includes/hub-project-name.mdx'
    ...
    - The left navigation in the Management center has two sections. In a <FdpProjectName />. the sections are for the **resource** the project is in, then a section for the **project** itself. In a <HubProjectName />, the sections are for the **hub** that the project is in, then a section for the **project** itself.
...
- Listen for either **(AI Foundry)** or **Foundry project** for a <FdpProjectName />. 
import HubProjectName from '/snippets/ai-foundry/includes/hub-project-name.mdx'

- Listen for **(Hub)** for a <HubProjectName />.
...
Prompt flow is available only in a <HubProjectName />. 
