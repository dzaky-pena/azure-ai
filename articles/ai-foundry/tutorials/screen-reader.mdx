...
- Navigation - There are three different states:
    ...
    - The left navigation in the Management center has two sections. In a [!INCLUDE [fdp-project-name](../includes/fdp-project-name)]. the sections are for the **resource** the project is in, then a section for the **project** itself. In a [!INCLUDE [hub-project-name](../includes/hub-project-name)], the sections are for the **hub** that the project is in, then a section for the **project** itself.
...
Once you select a project, you can access more capabilities such as Model catalog, Playgrounds, and AI Services.
...
For more information about the navigation, see [What is Azure AI Foundry](../what-is-azure-ai-foundry).

## Projects 

To work within the Azure AI Foundry portal, you must first [create a project](../how-to/create-projects): 
...
- Listen for either **(AI Foundry)** or **Foundry project** for a [!INCLUDE [fdp-project-name](../includes/fdp-project-name)]. 
- Listen for **(Hub)** for a [!INCLUDE [hub-project-name](../includes/hub-project-name)].


## Using prompt flow 

Prompt flow is available only in a [!INCLUDE [hub-project-name](../includes/hub-project-name)]. 
...
* Learn how you can build generative AI applications in the [Azure AI Foundry](../what-is-azure-ai-foundry).
* [Build a custom knowledge retrieval (RAG) app with the Azure AI Foundry SDK](copilot-sdk-create-resources)
