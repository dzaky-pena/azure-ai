...
[!INCLUDE [code-create-openai-client](../../foundry-models/includes/code-create-openai-client)]

[!INCLUDE [code-create-openai-chat-completion](../../foundry-models/includes/code-create-openai-chat-completion)]
