...
Detecting indirect attacks requires using document delimiters when constructing the prompt. See the [Document embedding in prompts for Azure OpenAI](../../openai/concepts/content-filter-document-embedding) section to learn more.  

---

## Configurability

import ContentFilterConfigurability from '/snippets/ai-foundry/foundry-models/includes/content-filter-configurability.mdx'
