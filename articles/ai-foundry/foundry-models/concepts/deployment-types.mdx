...
<Frame>
  ![](/images/ai-foundry/foundry-models/media/add-model-deployments/models-deploy-deployment-type.png)
</Frame>
...
Customers with high consistent volume may experience greater latency variability. The threshold is set per model. See the [quotas page to learn more](../../model-inference/quotas-limits).  For applications that require the lower latency variance at large workload usage, we recommend purchasing provisioned throughput.
...
Administrators can control which model deployment types are available to their users by using Azure Policies. Learn more about [How to control AI model deployment with custom policies](../../../ai-studio/how-to/custom-policy-model-deployment).

## Related content

- [Quotas & limits](../../model-inference/quotas-limits)
- [Data privacy, and security for Azure AI Foundry Models](../../how-to/concept-data-privacy)
