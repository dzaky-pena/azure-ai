...
<Frame>
  ![](/images/ai-foundry/media/evaluations/red-teaming-agent/map-measure-mitigate-ai-red-teaming.png)
</Frame>
...
In production, we recommend implementing **safety mitigations** such as [Azure AI Content Safety filters](../../ai-services/content-safety/overview) or implementing safety system messages using our [templates](../openai/concepts/safety-system-message-templates).
...
<Frame>
  ![](/images/ai-foundry/media/evaluations/red-teaming-agent/how-ai-red-teaming-works.png)
</Frame>
...
Get started with our [documentation on how to run an automated scan for safety risks with the AI Red Teaming Agent](../how-to/develop/run-scans-ai-red-teaming-agent).
