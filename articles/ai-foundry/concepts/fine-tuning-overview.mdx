...
To find steps to fine-tuning a model in AI Foundry, see [Fine-tune Models in AI Foundry](../how-to/fine-tune-serverless) or [Fine-tune models using managed compute](../how-to/fine-tune-managed-compute). For detailed guidance on OpenAI fine-tuning see [Fine-tune Azure OpenAI Models](../openai/how-to/fine-tuning).
...
To find steps to fine-tuning a model in AI Foundry, see [Fine-tune Models in AI Foundry](../how-to/fine-tune-serverless), [Fine-tune Azure OpenAI Models](../openai/how-to/fine-tuning), or [Fine-tune models using managed compute](../how-to/fine-tune-managed-compute).
