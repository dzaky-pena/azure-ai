...
Hub and [!INCLUDE [hub](../includes/hub-project-name)] resources are implementations of the Azure Machine Learning workspace and encrypt data in transit and at rest. For details, see [Data encryption with Azure Machine Learning](../../machine-learning/concept-data-encryption).
...
- You must grant your [!INCLUDE [fdp](../includes/fdp-project-name)] system-assigned managed identity the following permissions on your key vault: *get key*, *wrap key*, *unwrap key*.
...
* After deployment, your [!INCLUDE [fdp](../includes/fdp-project-name)] can't switch from Microsoft-managed keys to customer-managed keys or vice versa.
...
1. Under the encryption tab, select your encryption key.
    ...
    :::image source="../../machine-learning/media/concept-customer-managed-keys/cmk-service-side-encryption.png" alt-text="Screenshot of the encryption tab with the option for service side encryption selected." lightbox="../../machine-learning/media/concept-customer-managed-keys/cmk-service-side-encryption.png":::
    <Frame>
      ![](TODO : images)
    </Frame>
