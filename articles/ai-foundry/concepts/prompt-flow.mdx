...
<Frame>
  ![](/images/ai-foundry/media/prompt-flow/type-or-gallery.png)
</Frame>
...
<Frame>
  ![](/images/ai-foundry/media/prompt-flow/dag-graph-example.png)
</Frame>
...
In Azure AI Foundry portal, tool options include the [LLM tool](../how-to/prompt-flow-tools/llm-tool), [Prompt tool](../how-to/prompt-flow-tools/prompt-tool), [Python tool](../how-to/prompt-flow-tools/python-tool), and more.

<Frame>
  ![](/images/ai-foundry/media/prompt-flow/tool-options.png)
</Frame>
...
- [Build with prompt flow in Azure AI Foundry portal](../how-to/flow-develop)
