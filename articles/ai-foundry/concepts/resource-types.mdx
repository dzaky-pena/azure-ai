...
* **Azure AI Search** – A resource used to index and retrieve data for grounding AI applications. It can be [connected](../how-to/connections-add) to Azure AI Foundry agents to enable retrieval-augmented generation (RAG) and semantic search experiences.
...
* [Create AI Foundry with advanced options](../how-to/create-resource-template)
* [Create a first AI Hub](../how-to/create-azure-ai-resource)
* [Create AI Hub with advanced options](../how-to/create-azure-ai-hub-template)
