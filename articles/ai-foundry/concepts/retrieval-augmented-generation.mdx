...
<Frame>
  ![](/images/ai-foundry/media/index-retrieve/rag-pattern.png)
</Frame>
...
<Frame>
  ![](/images/ai-foundry/media/index-retrieve/rag-pattern-with-index.png)
</Frame>
...
- [Create a vector index](../how-to/index-add)
