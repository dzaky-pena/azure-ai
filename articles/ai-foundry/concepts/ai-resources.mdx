...
<Note>
You must use a **[!INCLUDE [hub](../includes/hub-project-name)]** for the features mentioned in this article. A **[!INCLUDE [fdp](../includes/fdp-project-name)]** is not supported. For more information, see [Project types](../what-is-azure-ai-foundry.md#which-type-of-project-do-i-need).
</Note>
...
- [Create a [!INCLUDE [hub-project-name](../includes/hub-project-name)]](../how-to/create-projects.md?pivots=hub-project)
