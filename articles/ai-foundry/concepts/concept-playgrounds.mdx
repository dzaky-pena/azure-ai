...
<Frame>
  ![](/images/ai-foundry/media/concept-playgrounds/playground-landing-page.png)
</Frame>
<Tip>
...
1. Select **Open in VS Code** to open VS Code in a new tab of your browser window.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/open-in-vs-code-foundry.png)
    </Frame>
...
1. You're redirected to the `/azure` environment of VS Code where your code sample, API endpoint and key are already imported from the Azure AI Foundry playground.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/open-in-vs-code-vscode.png)
    </Frame>
...
The agents playground allows you to explore, prototype, and test agents without needing to run any code. From this page, you can quickly iterate and experiment with new ideas. To get started with the Agents playground, see the [Quickstart: Create a new agent](../../ai-services/agents/quickstart).

<Frame>
  ![](/images/ai-foundry/media/concept-playgrounds/agents-playground.png)
</Frame>

## Chat playground

The chat playground is the place to test the latest reasoning models from Azure OpenAI, DeepSeek, and Meta. To learn more about the chat playground, see the [Quickstart: Use the chat playground in Azure AI Foundry portal](../quickstarts/get-started-playground).
...
<Frame>
  ![](/images/ai-foundry/media/concept-playgrounds/chat-playground-cot-summary.png)
</Frame>
...
1. Download the audio file to your local computer.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/audio-playground-text-to-speech.png)
    </Frame>
...
1. Select **Generate transcription** to send the audio input to the model and receive a transcribed output in both text and JSON formats.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/audio-playground-transcribe.png)
    </Frame>
...
1. On the homepage of the video playground, get inspired by **pre-built prompts** sorted by the **industry** filter. From here, you can view the videos in full display and copy the prompt to build from it.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/video-playground-copy-prompt.png)
    </Frame>
...
1. Select **Update** to update the prompt, and then select **Generate** to create a new video.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/video-playground-rewrite-prompt-with-ai.png)
    </Frame>
...
1. Either in full screen mode or through the options button that shows up when you hover across the video, download the videos to your local computer, view the video generation information tag, view code, or delete the video.
    ...
    <Frame>
        ![](/images/ai-foundry/media/concept-playgrounds/options-menu-for-generated-video.png)
    </Frame>
...
- [Use the chat playground in Azure AI Foundry portal](../quickstarts/get-started-playground)
- [Quickstart: Create a new agent (Preview)](../../ai-services/agents/quickstart)
