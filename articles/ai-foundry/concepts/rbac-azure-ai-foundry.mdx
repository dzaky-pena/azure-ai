...
Azure AI Foundry supports two types of projects: a **<Fdp />** and a **<Hub />**. For more information about the differences between these two project types, see [Types of projects](../what-is-azure-ai-foundry.md#project-types). Use the selector at the top of this article to switch between the two project types.
...
- [How to add a new connection in Azure AI Foundry portal](../how-to/connections-add)
...
You can add users and assign roles directly from Azure AI Foundry at either the hub or project level. In the [management center](management-center), select **Users** in either the hub or project section, then select **New user** to add a user. 
...
<Frame>
  ![](/images/ai-foundry/media/concepts/hub-overview-add-user.png)
</Frame>
    
You're then prompted to enter the user information and select a built-in role.

<Frame>
  ![](/images/ai-foundry/media/concepts/add-resource-users.png)
</Frame>
...
| Authentication method | Public network access disabled | Azure Container RegistryPublic network access enabled |
| ---- | :----: | :----: |
| Admin user | ✓ | ✓ |
| Azure AI Foundry hub system-assigned managed identity | ✓ | ✓ |
| Azure AI Foundry hub user-assigned managed identity with the **ACRPull** role assigned to the identity |  | ✓ |
...
- [How to create an Azure AI Foundry hub](../how-to/create-azure-ai-resource)
- [How to create an Azure AI Foundry project](../how-to/create-projects)
- [How to create a connection in Azure AI Foundry portal](../how-to/connections-add)
