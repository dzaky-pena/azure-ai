...
Azure AI Foundry supports two types of projects: a **<Hub />** and a **<Fdp />**. In most cases, you'll want to use a <FdpProjectName />.
...
* In general, you should use a <FdpProjectName /> if you are looking to build agents or work with models. 
import HubProjectName from '/snippets/ai-foundry/includes/hub-project-name.mdx'
import FdpProjectName from '/snippets/ai-foundry/includes/fdp-project-name.mdx'

* Use a <HubProjectName /> when you need features that are not available in a <FdpProjectName />. See the following table for more on feature availability.


This table summarizes features available in the two project types:  


| Capability | <Fdp /> | [!INCLUDE[hub](includes/hub-project-name)] |
| --- | --- | --- |
...
* From the **breadcrumb navigation** section
    ...
    * A <FdpProjectName /> displays **(AI Foundry)** on the second line
import HubProjectName from '/snippets/ai-foundry/includes/hub-project-name.mdx'

    * A <HubProjectName /> displays **(Hub)** on the second line
...
* From the **All resources** page
    ...
    * A <FdpProjectName /> displays **(AI Foundry)** as the parent resource
import HubProjectName from '/snippets/ai-foundry/includes/hub-project-name.mdx'

    * A <HubProjectName /> displays **(Hub)** as the parent resource
