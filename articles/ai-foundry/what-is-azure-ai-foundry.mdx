...
Azure AI Foundry supports two types of projects: a **[!INCLUDE [hub](includes/hub-project-name)]** and a **[!INCLUDE [fdp](includes/fdp-project-name)]**. In most cases, you'll want to use a [!INCLUDE [fdp-project-name](includes/fdp-project-name)].

* [!INCLUDE [fdp-description](includes/fdp-description)]

* [!INCLUDE [hub-description](includes/hub-description)]


### Which type of project do I need?

* In general, you should use a [!INCLUDE [fdp-project-name](includes/fdp-project-name)] if you are looking to build agents or work with models. 
* Use a [!INCLUDE [hub-project-name](includes/hub-project-name)] when you need features that are not available in a [!INCLUDE [fdp-project-name](includes/fdp-project-name)]. See the following table for more on feature availability.


This table summarizes features available in the two project types:  


| Capability | [!INCLUDE [fdp](includes/fdp-project-name)] | [!INCLUDE[hub](includes/hub-project-name)] |
| --- | --- | --- |
...
* From the **breadcrumb navigation** section
    ...
    * A [!INCLUDE [fdp-project-name](includes/fdp-project-name)] displays **(AI Foundry)** on the second line
    * A [!INCLUDE [hub-project-name](includes/hub-project-name)] displays **(Hub)** on the second line

    <Frame>
      ![](/images/ai-foundry/media/how-to/projects/breadcrumb.png)
    </Frame>

* From the **All resources** page

    * A [!INCLUDE [fdp-project-name](includes/fdp-project-name)] displays **(AI Foundry)** as the parent resource
    * A [!INCLUDE [hub-project-name](includes/hub-project-name)] displays **(Hub)** as the parent resource

    <Frame>
      ![](/images/ai-foundry/media/how-to/projects/all-resources.png)
    </Frame>
...
For more information, see [Management center overview](./concepts/management-center).
...
Using Azure AI Foundry also incurs cost associated with the underlying services. To learn more, read [Plan and manage costs for Azure AI services](./how-to/costs-plan-manage).

## Region availability

Azure AI Foundry is available in most regions where Azure AI services are available. For more information, see [region support for Azure AI Foundry](reference/region-support).

## How to get access

You can [explore Azure AI Foundry portal (including the model catalog)](./how-to/model-catalog-overview) without signing in. 
