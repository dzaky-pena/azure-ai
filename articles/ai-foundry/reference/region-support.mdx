...
Azure AI Foundry is currently available in the following Azure regions. You can create [either a <FdpProjectName /> or <HubProjectName /> in Azure AI Foundry](../how-to/create-projects) in these regions.
