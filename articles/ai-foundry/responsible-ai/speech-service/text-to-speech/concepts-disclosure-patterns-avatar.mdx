...
|Category | Examples |
|--------------|-------------|
| Explicit disclosure patterns   | <ul><li>[Transparent Introduction](#transparent-introduction)</li><li>[Verbal Transparent Introduction](#verbal-transparent-introduction)</li> <li> [Explicit Byline](#explicit-byline)</li>  <li>[Parental Disclosure](#parental-disclosure)</li><li> [Providing opportunities to learn more about how the avatar was made](#providing-opportunities-to-learn-more-about-how-the-avatar-was-made)</li></ul> |
...
![A diagram of transparent introduction during first run experience.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/transparent-intro-first-avatar.png) 
...
![A diagram of Transparent introduction during return user experience.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/transparent-intro-return-avatar.png)
...
![A diagram of Verbally spoken transparent introduction.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/verbal-transparent.png)

### Explicit byline

Use this pattern if the user will be interacting with a video player or interactive component to trigger the avatar.

![A diagram of explicit byline in a news media scenario.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/explicit-byline-2.png) <br/>
...
![A screenshot of Disclosure for parents.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/parent-disclosure-avatar.png)<br/>
...
![A screenshot of entry point to learn more](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/learn-more-entry-point-avatar.png)<br/>
...
![A screenshot of providing users more information about synthetic voice.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/learn-more.png)<br/>
...
![A screenshot of Example of default responses to a conversation that you can craft.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/capability-disclosure.png)<br/>
