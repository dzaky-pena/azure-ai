...
![A diagram of the spectrum of disclosure patterns.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/affordances.png)
...
| --- | --- | --- |
| Requires High Disclosure  | Use at least one explicit pattern and implicit cues up front to helps users build associations. |<ul><li>[Explicit Disclosure](#explicit-disclosure)</li></ul>[Implicit Disclosure](#implicit-disclosure)  |
| Requires Low Disclosure | Disclosure may be minimal or unnecessary, but could benefit from some implicit patterns. | <ul><li> [Capability Disclosure](#capability-disclosure)</li></ul>[Conversational Transparency](#conversational-transparency)  |
| Has a high level of engagement | Build for the long term and offer multiple entry points to disclosure along the user journey. It is highly recommended to have an onboarding experience. | <ul><li>[Transparent Introduction](#transparent-introduction)</li><li>[Customization and Calibration](#customization-and-calibration)</li><li>[Capability Disclosure](#capability-disclosure)</li></ul> |
...
![A diagram of the transparent introduction during first run experience.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/transparent-intro-first.png) <br/>
...
![A diagram of Transparent introduction during return user experience.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/transparent-intro-return.png)
...
![A diagram of Verbally spoken transparent introduction.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/spoken-prompt-1.png)
...
![A diagram of Verbally spoken transparent introduction in first person.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/spoken-prompt-2.png)<br/>
...
![A diagram of Explicit byline in a news media scenario.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/explicit-byline.png) <br/>
...
![A diagram of User preferences.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/customization-user-control.png)<br/>
...
![A diagram of Voice customization.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/customization-voice-type.png)<br/>
...
![A diagram of Disclosure for parents.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/parental-disclosure.png)<br/>
...
![A diagram of Entry point to learn more.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/learn-more-entry-point.png)<br/>
...
![A diagram of providing users more information about synthetic voice.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/learn-more.png)<br/>
...
![A diagram of Consistency of implicit cues.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/consistency.png)
...
![A diagram of Visual cues and feedback.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/visual-affordances.png)<br/>
...
![A diagram of Example of default responses to a conversation that you can craft.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/capability-disclosure.png)<br/>
...
![A diagram of Handling unexpected paths.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/conversational-transparency-1.png)<br/>
...
![A diagram of Handling off task questions.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/conversational-transparency-2.png)
...
![A diagram of Disclosure opportunities throughout a user journey.](/images/ai-foundry/responsible-ai/speech-service/text-to-speech/media/touchpoints.png)<br/>
