...
For Azure AI Language, certain dialects and language varieties within our supported languages and text from some demographic groups may not yet have enough representation in our current training datasets. We encourage you to review our [responsible use guidelines](guidance-integration-responsible-use), and if you encounter performance differences, we encourage you to let us know.
...
* [Transparency note for text analytics for health](transparency-note-health)
...
* [Transparency note for custom Named Entity Recognition (NER)](custom-named-entity-recognition-transparency-note)
* [Transparency note for custom text classification](custom-text-classification-transparency-note)
* [Transparency note for conversational language understanding](..\clu\clu-transparency-note)
...
* [Data Privacy for Azure AI Language](data-privacy)
