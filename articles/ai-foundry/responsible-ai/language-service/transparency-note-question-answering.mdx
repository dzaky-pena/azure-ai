...
![Image of an example question and answer with metadata.](/images/ai-foundry/responsible-ai/language-service/media/qna-table.png)
...
content.](/images/ai-foundry/responsible-ai/language-service/media/request-response.png)
