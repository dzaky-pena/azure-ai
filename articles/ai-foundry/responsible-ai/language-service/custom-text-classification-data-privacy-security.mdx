...
![Diagram that shows how data is processed.](/images/ai-foundry/responsible-ai/language-service/media/custom-text-classification-rai-privacy-chart.png)
...
* [Custom text classification Transparency Note](custom-text-classification-transparency-note)
