...
* [!INCLUDE [regulatory-considerations](../includes/regulatory-considerations)]
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/named-entity-resolution-false-positive.png)
</Frame>

<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/substance-use-misclassification.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/named-entity-resolution-false-negative.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/ethnicity-misclassification.png)
</Frame>

<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/employment-misclassification.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/relation-extraction-false-negative.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/entity-linking-false-negative.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/negation-detection-resolution-false-positive.png)
</Frame>
...
<Frame>
    ![](/images/ai-foundry/responsible-ai/language-service/media/negation-detection-resolution-false-negative.png)
</Frame>
...
* [Transparency note for Azure AI Language](transparency-note)
* [Transparency note for Named Entity Recognition and Personally Identifying Information](transparency-note-named-entity-recognition)
* [Transparency note for Key Phrase Extraction](transparency-note-key-phrase-extraction)
* [Transparency note for Language Detection](transparency-note-language-detection)
* [Transparency note for Question answering](transparency-note-question-answering)
* [Transparency note for Summarization](transparency-note-extractive-summarization)
* [Transparency note for Sentiment Analysis](transparency-note-sentiment-analysis)
* [Data Privacy and Security for  Azure AI Language](data-privacy)
* [Guidance for integration and responsible use with Azure AI Language](guidance-integration-responsible-use)
