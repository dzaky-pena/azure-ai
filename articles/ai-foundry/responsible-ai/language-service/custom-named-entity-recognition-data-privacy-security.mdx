...
![Diagram that shows how data is processed.](/images/ai-foundry/responsible-ai/language-service/media/custom-named-entity-recognition-rai-privacy-chart.png)
...
* [Custom NER transparency note](custom-named-entity-recognition-transparency-note)
