...
![A diagram of an example question and answer with metadata.](/images/ai-foundry/responsible-ai/qnamaker/media/qnamaker-qna-table.png)
...
![A diagram of asking a bot a question, and getting an answer from knowledge base content.](/images/ai-foundry/responsible-ai/qnamaker/media/qnamaker-request-response.png)
