...
|----|---------|
| True positive or correct match ![True positive or correct match accept](/images/ai-foundry/responsible-ai/face/media/Accuracy/1.png) | The person in the [probe image](transparency-note) is [enrolled](transparency-note) and they are correctly matched.    |
| True negative or correct reject  ![True negative or correct reject](/images/ai-foundry/responsible-ai/face/media/Accuracy/2.png)       | The person in the probe image is not enrolled and the system finds no match.    |
| False positive or incorrect match  ![False positive or incorrect match](/images/ai-foundry/responsible-ai/face/media/Accuracy/3.png)   | Either the person in the probe image is not *enrolled* but is matched to an *enrolled* person OR the person in the probe image is enrolled but is matched with the wrong person. |
| False negative or incorrect reject  ![False negative or incorrect reject](/images/ai-foundry/responsible-ai/face/media/Accuracy/4.png) | The person in the probe image is enrolled, but the system finds no match.|
...
![A small photo of people walking.](/images/ai-foundry/responsible-ai/face/media/face-size.png)
...
![Photo of a person's face, with face rectangle shown.](/images/ai-foundry/responsible-ai/face/media/face-orientation.png) 
![Diagram of the head pose axes.](/images/ai-foundry/responsible-ai/face/media/head-pose.jpg)
...
![Photo of a person outside at night.](/images/ai-foundry/responsible-ai/face/media/Lighting.png)
...
![Photo of a man surrounded by confetti.](/images/ai-foundry/responsible-ai/face/media/Occlusion.png)
...
![Photo of a person's drivers license next to a different photo of the same person.](/images/ai-foundry/responsible-ai/face/media/appearance-changes.png)
...
![Photo of people walking, with motion blur.](/images/ai-foundry/responsible-ai/face/media/Motion.png)
...
![Two photos of identical twins using computers.](/images/ai-foundry/responsible-ai/face/media/biometric-twins.png)
