...
- **Foundry Local** installed on your computer. Read the [Get started with Foundry Local](../get-started) guide for installation instructions.
...
- [Integrate inferencing SDKs with Foundry Local](how-to-integrate-with-inference-sdks)
