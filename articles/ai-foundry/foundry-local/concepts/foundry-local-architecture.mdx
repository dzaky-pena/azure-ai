...
<Frame>
  ![](/images/ai-foundry/foundry-local/media/architecture/foundry-local-arch.png)
</Frame>
...
<Tip>
To learn more about compiling models for Foundry Local, read [How to compile Hugging Face models to run on Foundry Local](../how-to/how-to-compile-hugging-face-models).
</Tip>
...
<Tip>
To learn more about the CLI commands, read [Foundry Local CLI Reference](../reference/reference-cli).
</Tip>
...
<Tip>
To learn more about integrating with inferencing SDKs, read [Integrate inferencing SDKs with Foundry Local](../how-to/how-to-integrate-with-inference-sdks).
</Tip>
...
- [Get started with Foundry Local](../get-started)
- [Integrate inferencing SDKs with Foundry Local](../how-to/how-to-integrate-with-inference-sdks)
