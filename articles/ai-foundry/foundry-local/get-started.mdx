...
1. **Run your first model** Open a terminal window and run the following command to run a model: 
    ...
    <Frame>
        ![](/images/ai-foundry/foundry-local/media/get-started-output.png)
    </Frame>
...
<Tip>
For a complete guide to all CLI commands and their usage, see the [Foundry Local CLI Reference](reference/reference-cli).
</Tip>
...
- [Learn about best practices and troubleshooting](reference/reference-best-practice)
- [Explore the Foundry Local API reference](reference/reference-catalog-api)
- [Learn Compile Hugging Face models](how-to/how-to-compile-hugging-face-models)
