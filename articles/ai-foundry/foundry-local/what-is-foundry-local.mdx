...
Install and run your first model by following the [Get started with Foundry Local](get-started) guide. This guide helps you set up Foundry Local, discover available models, and launch your first local AI model.

## Next steps

- [Get started with Foundry Local](get-started)
- [How to compile Hugging Face models to run on Foundry Local](how-to/how-to-compile-hugging-face-models)
